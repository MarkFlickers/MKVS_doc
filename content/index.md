...
| № | Тема | Статус |
| --- | --- | --- |
| 01 | [[lab01/index\|Интегрированная среда разработки PlatformIO и Visual Studio Code]] | не принимается |
| 02 | [[lab02/index\|CMSIS. Семихостинг. Порты ввода-вывода общего назначения]] | не принимается |
| 03 | [[lab03/index\|Исключения и прерывания. Обработка ошибок. Загрузчик]] | принимается с понижением |
| 04 | [[lab04/index\|Системный таймер. Программные таймеры. Кооперативный планировщик. Библиотека LL]] | принимается с понижением |
| 05 | [[lab05/index\|Контроллер внешних прерываний EXTI. Поворотный инкрементальный энкодер]] | принимается |
| 06 | [[lab06/index\|Библиотека HAL. Последовательный асинхронный интерфейс UART]] | принимается |
| 07 | [[lab07/index\|Аппаратные таймеры]] | не объяснялась |
| 08 | [[lab08/index\|Основы встраиваемых операционных систем реального времени на примере FreeRTOS]] | не объяснялась |

> [!note] Замечания и предложения
> Замечания к текстам работ и предложения — через issue или pull request в [репозитории](https://github.com/MarkFlickers/MKVS_doc).
