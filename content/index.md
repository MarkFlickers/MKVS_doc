...
| № | Тема | Статус |
| --- | --- | --- |
| 01 | [[lab01/index\|Интегрированная среда разработки PlatformIO и Visual Studio Code]] | не объяснялась |
| 02 | [[lab02/index\|CMSIS. Семихостинг. Порты ввода-вывода общего назначения]] | не объяснялась |
| 03 | [[lab03/index\|Исключения и прерывания. Обработка ошибок. Загрузчик]] | не объяснялась |
| 04 | [[lab04/index\|Системный таймер. Программные таймеры. Кооперативный планировщик. Библиотека LL]] | не объяснялась |
| 05 | [[lab05/index\|Контроллер внешних прерываний EXTI. Поворотный инкрементальный энкодер]] | не объяснялась |
| 06 | [[lab06/index\|Библиотека HAL. Последовательный асинхронный интерфейс UART]] | не объяснялась |
