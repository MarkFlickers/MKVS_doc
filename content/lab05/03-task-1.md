...
Энкодер занимает чётные контакты разъёма: GND — контакт 12, «+» — контакт 14 (PE2), SW — контакт 16 (PE4), DT — контакт 18 (PE5), CLK — контакт 20 (PE6).
...
Сигналы SW, DT и CLK подключены напрямую к портам ввода-вывода микроконтроллера: SW — PG12, DT — PG14, CLK — PG8.
...
Энкодер занимает нечётные контакты разъёма: CLK — контакт 19 (PD13), DT — контакт 21 (PD12), SW — контакт 23 (PD11), «+» — контакт 25 (PE2), GND — контакт 27.
