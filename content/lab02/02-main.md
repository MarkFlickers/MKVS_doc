...
3. Откройте файл `system/system.c` и изучите код системного файла.
   ...
   Проверьте с помощью документа UM2408 значение частоты внешнего генератора [[glossary/hse\|HSE]], используемое по умолчанию. При необходимости переопределите макрос, указав правильное значение.
