...
2. В главном цикле программы ([[glossary/superloop\|суперцикле]]) обработчики задач вызываются с заданной частотой. В свободное от обработки время процессор переходит в режим пониженного энергопотребления, и основную часть времени программа проводит во сне (рисунок 3).
