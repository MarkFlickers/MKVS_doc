...
Цель настоящей лабораторной работы — освоить процесс разработки программного обеспечения с использованием PlatformIO и Visual Studio Code. Полученные знания и практические навыки будут использованы при выполнении последующих практических заданий.

Visual Studio Code – это специализированный текстовый редактор с поддержкой большого числа языков программирования и функциональных расширений. Одним из таких расширений является PlatformIO – среда разработки, объединяющая различные инструменты для создания программ для микроконтроллеров. Помимо редактора и компилятора PlatformIO и VS Code предоставляют такие инструменты, как отладчик, средства автоматизированного тестирования кода, статический анализатор и монитор (текстовый терминал для взаимодействия с целевым устройством, на котором выполняется разработанная программа).
...
Напишите тесты для проверки работы созданной функции. Проверьте решение тестами и статическим анализатором.
...
1. Настройте статический анализатор cppcheck для проверки правил стандарта MISRA C:2012.
...
2. Проведите анализ кода библиотеки dynlist на соответствие правилам MISRA C:2012.
