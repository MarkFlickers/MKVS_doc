...
// styles/mkvs/_compact.scss): там колонка превращается в верхнюю панель, и Проводник
...
// раскладка в styles/mkvs/_layout.scss) и запоминается в localStorage. Атрибут ставится
